...
class CustomResultSet implements ResultSet{
	...
	CustomResultSet(IResultSetData resultSetData){
		...
		if(!hasData) return;
		for(int i =0; i < resultSetData.getColumns().size(); i++){
			colNameIndex.put(resultSetData.getColumns().get(i), i);
		}
		metaData = new MYMetadata( resultSetData.getColumns());
	}
	...
	public boolean next() throws SQLException {
		// TODO Auto-generated method stub
		if(!hasData || cursor + 1 >= resultSetData.getResult().size())
		return false;
		cursor++;
		return true;
	}
	...
	public Date getDate(int columnIndex) throws SQLException {
		...
		try {
			return o == null ? null : new Date(df.parse(o.toString()).getTime());
	...
	public Time getTime(int columnIndex) throws SQLException {
		// TODO Auto-generated method stub
		Object o = getObjectAtIndex(columnIndex-1);
		return o == null ? null : (Time)Time.valueOf(o.toString());
	}
	...
	public Timestamp getTimestamp(int columnIndex) throws SQLException {
		// TODO Auto-generated method stub
		Object o = getObjectAtIndex(columnIndex-1);
		return o == null ? null : (Timestamp)Timestamp.valueOf(o.toString());
	}
	...
	class MYMetadata implements ResultSetMetaData{
		...
		MYMetadata(List<String> columns ){
			this.colums = columns;
		}
